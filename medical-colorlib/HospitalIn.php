...
<div class="login-form">  
    ...
    <form action="Hospitalin.php" method="post">
    <div class="avatar"><i class="material-icons">&#xE7FF;</i></div>
      <h4 class="modal-title" style="text-align: center;">Institution Login</h4><br>
        ...
        <br>
        Don't have an account? <a href="HospitalReg.php">Sign up</a></div>             
    </form>  
