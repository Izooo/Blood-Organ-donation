                    ...
                    while ($row = $result->fetch_assoc()) {
                     ...
                     <tbody>
                      <tr>
                        ...
                        <td>
                        <a href='AdminDonorUpdate.php?DonorID=".$row['DonorID']."'><i class='material-icons'>update</i></a>
                        </td>
                        <td>
                        <a href='AdminDonorDelete.php?DonorID=".$row['DonorID']."'><i class='material-icons'>delete</i></a>
                        </td>
                        <td>
                        <a href='AdminDonorAdd.php'><i class='material-icons'>add_circle_outline</i></a>
                        </td>
